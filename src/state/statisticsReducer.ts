...
type StatisticsActionsType = ChangeStatusStatisticsAT
...
export const statisticsReducer = (state: statisticsStateType = initialState, action: StatisticsActionsType): statisticsStateType => {
    switch (action.type) {
...
export const setStatisticsClickAC = (clickType: clickValueType, number: number, counter: number, step: number) => ({
...
export const setStatisticsNumberAC = (numberType: numberValueType, number1: number, number2: number) => ({
